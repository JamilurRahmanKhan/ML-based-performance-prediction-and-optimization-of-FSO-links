...
ax_dist_slider = fig.add_subplot(gs[3, :])

# Controls row/area (adjust these slices to move items)
ax_radio = fig.add_subplot(gs[4:8, 0:3])         # Visualization Mode list
ax_rain = fig.add_subplot(gs[4, 4:6])            # Rain toggle (new)
